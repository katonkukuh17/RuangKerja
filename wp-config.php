...
define( 'DB_NAME', 'b3tkfk8bwfujbnx5avef' );

/** MySQL database username */
define( 'DB_USER', 'usd9o3ijkqklwlil' );

/** MySQL database password */
define( 'DB_PASSWORD', 's6iF75fgqoQkb4NtsNmw' );

/** MySQL hostname */
define( 'DB_HOST', 'b3tkfk8bwfujbnx5avef-mysql.services.clever-cloud.com' );
